...
class Request {
     ...
     */
    getUser() {
        let sellRegex = new RegExp("WTS", "gi")
        let sellRegexReverse = new RegExp("BTW", "gi")
        let buyRegex = new RegExp("WTB", "gi")
        ...
        if (this.user.endsWith(sellRegex)) {
            this.user = this.user.reverse().replace(sellRegexReverse, "").reverse()
            this.message.unshift("WTS")
        }
        if (this.user.endsWith(buyRegex)) {
            this.user = this.user.reverse().replace(buyRegexReverse, "").reverse()
    ...
    cleanOffers() {
        for (let offer of this.offers) {
            ...
            offer.subMessage = offer.message ? offer.message.join(" ") : offer.message
